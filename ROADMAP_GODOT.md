...
- [x] M10 — Art + audio pass — **COMPLETE** (procedural synth + SFX + settings; 44 real sprites swapped in behind a `Sprites` loader, team ring/frame faction-ID). **PORT COMPLETE: real art + audio over full JS parity.**
